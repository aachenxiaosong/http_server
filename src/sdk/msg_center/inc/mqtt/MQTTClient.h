...
DLLExport int MQTTConnect(MQTTClient* client, MQTTPacket_connectData* options, int kl_max_tries,
    MQTTDisconHandler discon_handler);
 ...
 *  @return success code
 */
DLLExport int MQTTPublish(MQTTClient* client, char*, MQTTMessage*);
 ...
 *  @return success code
 */
DLLExport int MQTTSetMessageHandler(MQTTClient* c, char* topicFilter, messageHandler messageHandler);
 ...
 *  @return success code
 */
DLLExport int MQTTSubscribe(MQTTClient* client, char* topicFilter, enum QoS, messageHandler);
 ...
 *  @return success code
 */
DLLExport int MQTTSubscribeWithResults(MQTTClient* client, char* topicFilter, enum QoS, messageHandler, MQTTSubackData* data);
 ...
 *  @return success code
 */
DLLExport int MQTTUnsubscribe(MQTTClient* client, char* topicFilter);
