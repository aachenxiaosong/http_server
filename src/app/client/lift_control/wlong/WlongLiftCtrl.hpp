#ifndef APP_CLIENT_LIFT_CONTROL_WLONG_WLONG_LIFT_CTRL_H_
#define APP_CLIENT_LIFT_CONTROL_WLONG_WLONG_LIFT_CTRL_H_
...
#endif  //  APP_CLIENT_LIFT_CONTROL_WLONG_WLONG_LIFT_CTRL_H_