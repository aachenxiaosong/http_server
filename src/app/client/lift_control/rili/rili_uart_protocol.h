#ifndef APP_CLIENT_LIFT_CONTROL_RILI_RILI_UART_CLIENT_H_
#define APP_CLIENT_LIFT_CONTROL_RILI_RILI_UART_CLIENT_H_
...
#endif
#endif  //  APP_CLIENT_LIFT_CONTROL_RILI_RILI_UART_CLIENT_H_
