#ifndef LEFT_LIFT_CONTROL_BASE_HTTP_I_CALL_LIFT_HTTP_HANDLER_H_
#define LEFT_LIFT_CONTROL_BASE_HTTP_I_CALL_LIFT_HTTP_HANDLER_H_
...
#endif  //  LEFT_LIFT_CONTROL_BASE_HTTP_I_CALL_LIFT_HTTP_HANDLER_H_