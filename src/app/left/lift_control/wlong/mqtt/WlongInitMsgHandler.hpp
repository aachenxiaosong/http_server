#ifndef LEFT_LIFT_CONTROL_WLONG_MQTT_WLONG_INIT_MSG_HANDLER_H_
#define LEFT_LIFT_CONTROL_WLONG_MQTT_WLONG_INIT_MSG_HANDLER_H_
...
#endif  //  LEFT_LIFT_CONTROL_WLONG_MQTT_WLONG_INIT_MSG_HANDLER_H_
