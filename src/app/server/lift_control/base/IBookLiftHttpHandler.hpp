#ifndef SERVER_LIFT_CONTROL_BASE_I_BOOK_LIFT_HTTP_HANDLER_H_
#define SERVER_LIFT_CONTROL_BASE_I_BOOK_LIFT_HTTP_HANDLER_H_
...
#endif  //  SERVER_LIFT_CONTROL_BASE_I_BOOK_LIFT_HTTP_HANDLER_H_