#ifndef SERVER_LIFT_CONTROL_BASE_MQTT_INIT_INFO_HPP_
#define SERVER_LIFT_CONTROL_BASE_MQTT_INIT_INFO_HPP_
...
#endif  //  SERVER_LIFT_CONTROL_BASE_MQTT_INIT_INFO_HPP_