#ifndef SERVER_LIFT_CONTROL_WLONG_HTTP_WLONG_HTTP_SERVICE_H_
#define SERVER_LIFT_CONTROL_WLONG_HTTP_WLONG_HTTP_SERVICE_H_
...
#endif  //  SERVER_LIFT_CONTROL_WLONG_HTTP_WLONG_HTTP_SERVICE_H_