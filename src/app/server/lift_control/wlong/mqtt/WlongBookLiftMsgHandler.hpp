#ifndef SERVER_LIFT_CONTROL_WLONG_MQTT_WLONG_BOOK_LIFT_MSG_HANDLER_H_
#define SERVER_LIFT_CONTROL_WLONG_MQTT_WLONG_BOOK_LIFT_MSG_HANDLER_H_
...
#endif  //  SERVER_LIFT_CONTROL_WLONG_MQTT_WLONG_BOOK_LIFT_MSG_HANDLER_H_
