#ifndef SERVER_LIFT_CONTROL_RILI_HTTP_RILI_HTTP_SERVICE_H_
#define SERVER_LIFT_CONTROL_RILI_HTTP_RILI_HTTP_SERVICE_H_
...
#endif  //  SERVER_LIFT_CONTROL_RILI_HTTP_RILI_HTTP_SERVICE_H_