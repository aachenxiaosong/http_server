#ifndef APP_UP_SULINK_MQTT_MESSAGES_SULINK_PASS_RULE_HPP_
#define APP_UP_SULINK_MQTT_MESSAGES_SULINK_PASS_RULE_HPP_
...
#endif  //  APP_UP_SULINK_MQTT_MESSAGES_SULINK_PASS_RULE_HPP_
