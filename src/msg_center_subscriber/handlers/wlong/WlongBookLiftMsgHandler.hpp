#ifndef MSG_CENTER_SUBSCRIBER_HANDLERS_WLONG_WLONG_BOOK_LIFT_MSG_HANDLER_H_
#define MSG_CENTER_SUBSCRIBER_HANDLERS_WLONG_WLONG_BOOK_LIFT_MSG_HANDLER_H_
...
#endif  //  MSG_CENTER_SUBSCRIBER_HANDLERS_WLONG_WLONG_BOOK_LIFT_MSG_HANDLER_H_
