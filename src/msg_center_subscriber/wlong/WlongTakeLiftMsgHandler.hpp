#ifndef MSG_CENTER_SUBSCRIBER_WLONG_WLONG_TAKE_LIFT_MSG_HANDLER_H_
#define MSG_CENTER_SUBSCRIBER_WLONG_WLONG_TAKE_LIFT_MSG_HANDLER_H_
...
#endif  //  MSG_CENTER_SUBSCRIBER_WLONG_WLONG_TAKE_LIFT_MSG_HANDLER_H_
