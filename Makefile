...
LIB := -Llib/libevent -Llib/mqtt -Llib/poco -levent-2.2 -lpaho-mqtt3c -lPocoData -lPocoDataSQLite -lPocoFoundation -lPocoUtil -lPocoXML -lPocoJSON -lcurl -lm -lpthread
